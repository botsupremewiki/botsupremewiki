...
!!! info "Classe Premium"
    L'Ombre Venin nécessite le rôle **Premium** pour être sélectionné.
...
L'Ombre Venin a **30% de chance d'appliquer du poison** à chaque attaque, ajoutant **+35% ATK Phy par stack actif** aux dégâts de poison.
