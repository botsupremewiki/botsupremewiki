...
Le Support est la classe de **soutien, de survie et d'attaque polyvalente**. Il dispose d'excellentes capacités défensives, d'un soin puissant et d'une utilité maximale en groupe. C'est la classe la plus **complète et résistante** du jeu — aussi bien à l'aise en solo qu'indispensable en Raid.
